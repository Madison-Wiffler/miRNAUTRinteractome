...
```
![Caption](/images/logo.png){fig-alt="A line drawing of  contour-lines."}  
...
```
[![Caption](/images/logo.png " contour-lines"){fig-alt="A line drawing of  contour-lines."}](https://quarto.org) 


``` markdown                                                             
[![](/images/logo.png){fig-alt="Alt text"}](https://quarto.org)                                                                                
```
[![](/images/logo.png){fig-alt="A line drawing of  contour-lines."}](https://quarto.org)          
